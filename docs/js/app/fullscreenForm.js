...
;(function (window) {
  ...
  */
	FForm.prototype._addControls = function () {
		...
		//this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : 'Volgende stap', appendTo : this.ctrls } );
  ...
  */
	FForm.prototype._initEvents = function () {
		...
		this.fields.forEach(function (fld) {
			var continueBtn = fld.querySelector('.fs-continue');
  ...
  */
	FForm.prototype._updateNav = function () {
		if (this.options.ctrlNavDots) {
			...
			var itemLength = this.ctrlNavDots.length;
  ...
  */
	...
	FForm.prototype._showError = function (err) {
		...
		switch (err) {
			case 'NOVAL':
				message = 'Voer de gevraagde gegevens in om verder te gaan';
				break;
			case 'INVALIDEMAIL':
				message = 'Voer een geldig e-mailadres in om verder te gaan';
				break;
			// ...
		};
